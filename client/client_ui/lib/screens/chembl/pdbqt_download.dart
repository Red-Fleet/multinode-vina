...
class PdbqtDownload extends StatefulWidget {
  const PdbqtDownload({super.key});

  @override
  State<PdbqtDownload> createState() => _PdbqtDownloadState();
}

class _PdbqtDownloadState extends State<PdbqtDownload> {
  ...
  Future<void> downloadSdfs() async{
    ...
    for(var id in ids)
    {
      final response = await ChemblHttpService.pdbqtDownload(id, path);
