...
#     def createComputeTask(master_id:str, worker_id:str, target, ligands: list[str], target_name, ligands_name: list[str])-> str:
...
#             target=target, ligands=ligands, target_name=target_name,
